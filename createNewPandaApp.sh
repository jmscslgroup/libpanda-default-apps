...
chmod a+x ${APPNAMEFOLDER}/${STOPFILE} ${APPNAMEFOLDER}/${UNINSTALLFILE} ${APPNAMEFOLDER}/${STARTFILE} ${APPNAMEFOLDER}/${INSTALLROSPACKAGESFILE} ${APPNAMEFOLDER}/${INSTALLCONTROLLERFILE} ${APPNAMEFOLDER}/${INSTALLFILE}
